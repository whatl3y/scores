...
-----------------------------------------------------------------------------------------*/
DateTime.prototype.calculateDateTime = function(format,raw) {
...
-----------------------------------------------------------------------------------------*/
DateTime.prototype.convertUTCDateToLocal = function(format) {
...
-----------------------------------------------------------------------------------------*/
DateTime.prototype.human = function(type,data) {
...
|        false: failure
-----------------------------------------------------------------------------------------*/
DateTime.prototype.countdown = function(date1,date2,negative) {
...
-----------------------------------------------------------------------------------------*/
DateTime.prototype.genericParse = function(string) {
